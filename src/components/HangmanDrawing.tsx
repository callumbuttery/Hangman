...
const BODY = (
    <div style={{ width: "10px", height: "100px", background: 'black', position: "absolute", top: "119px", right: "0px" }}></div>
)

const RIGHT_ARM = (
    <div style={{ width: "100px", height: "10px", background: 'black', position: "absolute", top: "149px", right: "-100px", rotate: '-30deg', transformOrigin: 'left bottom' }}></div>
)

const LEFT_ARM = (
    <div style={{ width: "100px", height: "10px", background: 'black', position: "absolute", top: "149px", right: "10px", rotate: '30deg', transformOrigin: 'right bottom' }}></div>
)

const RIGHT_LEG = (
    <div style={{ width: "100px", height: "10px", background: 'black', position: "absolute", top: "209px", right: "-90px", rotate: '60deg', transformOrigin: 'left bottom' }}></div>
)
